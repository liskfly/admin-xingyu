<template>
    <div class="p-2" style="display: flex; gap: 10px">
      ...
      <el-dialog :append-to-body="true" :close-on-click-modal="false" title="用户角色" :visible.sync="addVisible" width="400px"
        @close="addCancel()">
  ...
  <el-dialog :append-to-body="true" :close-on-click-modal="false" title="添加员工" :visible.sync="addPwdVisible" width="400px"
    ...
    <el-form :model="addForm" ref="addFormRef" :rules="addRules" label-width="auto">
      ...
      <el-form-item label="新密码" prop="pwd">
        <el-input v-model="addForm.pwd" placeholder="请输入新密码" autocomplete="new-password" show-password clearable></el-input>
      </el-form-item>
      <el-form-item label="确认密码" prop="confirmPwd">
  ...
  <el-dialog :append-to-body="true" :close-on-click-modal="false" title="历史登录记录" :visible.sync="historyVisible" width="800px">
    <el-table
          size="small"
          :data="historyData"
          border
