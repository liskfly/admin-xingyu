  ...
  <div class="inboundRecord">
    <el-card class="box-card" :body-style="{ padding: '8px' }">
        ...
        <div>
          <el-form ref="form" class="form" :inline="true">
            <el-form-item label="工序">
              <el-select
                v-model="getText.SearchModel.StationCode"
                clearable
                style="width: 220px"
              >
                <el-option
      ...
      <div class="table_container">
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button type="primary" size="mini" :disabled="scope.row.Result == 'OK'" @click="openRepair(scope.row)">维修</el-button>
              <el-button type="info" size="mini" @click="">报废</el-button>
              <!-- <el-button type="warning" size="mini" @click="">误判</el-button> -->
    ...
    >
      ...
      >
        <el-row :gutter="20">
          <el-col :span="8" :offset="0">
            <el-form-item label="工序编码" prop="StationCode" class="mb-2">
              <el-input
                v-model="repairForm.StationCode"
                disabled
                style="width: 270px"
              ></el-input>
            </el-form-item>
          ...
          <el-col :span="8" :offset="0">
            <el-form-item label="工序名称" prop="StationName" class="mb-2">
              <el-input
                v-model="repairForm.StationName"
                disabled
                readonly
                style="width: 270px"
              ></el-input>
          ...
          <el-col :span="8" :offset="0">
            <el-form-item label="过程码或组件码" prop="SN" class="mb-2">
              <el-input
        ...
        <el-row :gutter="20">
          <el-col :span="8" :offset="0">
            <el-form-item label="类型" prop="MoveType" class="mb-2">
              <el-input
                v-model="repairMoveType"
                disabled
                readonly
                style="width: 270px"
              ></el-input>
        ...
        >
          ...
          <af-table-column
            prop="baddatadetail_item"
            label="不良点位"
          ></af-table-column>
          <af-table-column
            prop="baddatadetail_code"
            label="不良代码"
          ></af-table-column>
          <af-table-column
            prop="badphenomena_value"
            label="不良名称"
          ></af-table-column>
        </el-table>
      ...
      <span slot="footer">
        ...
        <el-button type="primary" @click="repairForm = false">确定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    openRepair(row) {
        this.repairForm = row;
        this.repairMoveType = row.MoveType == "movein" ? "入站" : "出站";
