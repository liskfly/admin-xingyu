    ...
    <div class="p-2">
        <el-card shadow="always" :body-style="{ padding: '8px' }">
            ...
            <el-table :data="tableData1.slice((currentPage - 1) * pageSize, currentPage * pageSize)
                ...
                <af-table-column prop="Tool" label="工治具编码" fixed> </af-table-column>
                <af-table-column prop="Model" label="工治具类别" > </af-table-column>
                <el-table-column prop="Cell" label="储位" width="100" > </el-table-column>
                ...
                <el-table-column prop="ExpireDate" label="到期日期" width="155">
                    <template slot-scope="scope">
                        <span :class="{'text-red': compressDate(scope.row.ExpireDate)}">{{ scope.row.ExpireDate}}</span>
                    </template>
                </el-table-column>
        ...
        <el-dialog :title="'添加'" :visible.sync="addVisible" @close="addCancel()" width="500px">
            <el-form :model="addForm" ref="addFormRef" label-width="auto">
                <el-form-item label="工治具编码" prop="compid">
                    <el-input v-model="addForm.compid" style="width: 280px;" placeholder="请输入工治具编码"
                        clearable></el-input>
                </el-form-item>
                ...
                <el-form-item label="到期日期" prop="expirationDate">
                    <el-date-picker v-model="addForm.expirationDate" style="width: 280px;" type="date"
        ...
        <el-dialog :title="'编辑'" :visible.sync="editVisible" @close="editCancel()" width="500px">
            <el-form :model="editForm" ref="editFormRef" label-width="auto">
                <el-form-item label="工治具编码" prop="compid">
                    <el-input v-model="editForm.compid" disabled style="width: 280px;" placeholder="请输入工治具编码"
                        clearable></el-input>
                </el-form-item>
                <el-form-item label="工治具类别" prop="compname">
                ...
                <el-form-item label="到期日期" prop="expirationDate">
                    <el-date-picker v-model="editForm.expirationDate" style="width: 280px;" type="date"
...
export default {
    ...
    methods: {
        ...
        addSumbit() {
            iDControll(this.addForm).then((res) => {
        ...
        editSumbit() {
            ...
            iDControll(this.editForm).then((res) => {
                if (res.data.Status == "OK") {
                    this.$notify({
                        title: "提示信息",
                        message: "修改成功",
