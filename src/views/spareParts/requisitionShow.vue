    ...
    <el-card shadow="always" :body-style="{ padding: '20px' }">
      ...
      <div class="table_container">
        ...
        >
          ...
          <el-table-column prop="Spare_User" label="领用人"> </el-table-column>
          <el-table-column prop="Spare_DateTime" label="领用时间">
          </el-table-column>
          <el-table-column prop="Spare_Unit" label="领用单位">
          </el-table-column>
          <el-table-column prop="Spare_Quantity" label="领用数量">
          </el-table-column>
          <el-table-column prop="create_uid" label="创建人ID">
          </el-table-column>
          <el-table-column prop="create_time" label="创建时间">
          </el-table-column>
          <el-table-column prop="update_uid" label="更新人ID">
          </el-table-column>
...
export default {
  ...
  methods: {
    getData() {
      this.startLoading();
      GetRequisitionPage(this.getText).then(({ data }) => {
