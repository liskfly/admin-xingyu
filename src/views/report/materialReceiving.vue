        ...
        <el-card shadow="always" :body-style="{ padding: '8px' }">
            <div>
                <el-form ref="formRef" :model="getForm" :inline="true" @submit.native.prevent>
                    ...
                    <el-form-item label="工单" class="mb-2"><el-input v-model="getForm.mfgordername" clearable
            ...
            <el-table :data="tableData.slice(
                ...
                " border :height="tableHeight" style="width: 100%" size="mini"  tooltip-effect="light">
            ...
            GetWoOperatorTrace(this.getForm).then(res => {
                if (res.Success) {
                    this.tableData = res.Data.map(item => {
                        ...
                        item.Timestamp =item.Timestamp==null?"": dayjs(item.Timestamp).format("YYYY-MM-DD HH:mm:ss");
                        return item;
                    });
                } else {
                    this.tableData = [];
